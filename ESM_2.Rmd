...
boot_ebmstate_object.4<-boot_ebmstate(mstate.data.expanded,which_group = groups,min_nr_samples = 100,patient_data = patient_data,tmat = tmat,initial_state = "MDS",time_model = "clockreset",backup_file = "./data/boot_ebmstate_backup.Rdata",input_file =NULL ,coxrfx_args = list(max.iter=200),probtrans_args = list(max_time=4000))
# save(boot_ebmstate_object.4,file="./data/boot_object_model4.Rdata")


#leave-one-out estimation for a sample of 196 patients
patient_IDs<-sample(unique(mstate.data$id),14*14)
loo_ebmstate_object.4<-loo_ebmstate(mstate.data,mstate.data.expanded,which_group = groups,patient_IDs=patient_IDs,initial_state="MDS",tmat=tmat,backup_file="./data/loo_ebmstate_backup.Rdata",input_file=NULL,time_model="clockreset",coxrfx_args=list(max.iter=200),probtrans_args = list(max_time=4000))
# save(loo_ebmstate_object.4,file="./data/loo_object_model4.Rdata")

```

```{r  echo=FALSE,eval=FALSE}
load("./data/fit_objects_model4.Rdata")
...
coefficients_CIs<-boot_ebmstate_object.4$coefficients_CIs
file_name<-"./plots/coef_plots_model4.png"
...
boot_object<-boot_ebmstate_object.4
...
probtrans_list<-loo_ebmstate_object.4$probtrans_objects_loo
