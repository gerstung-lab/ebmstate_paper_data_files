...
author:
- Rui J Costa^[European Bioinformatics Institute (EMBL-EBI), rui.costa@ebi.ac.uk]
...
subtitle: <font size="2"> This document is part of the supplementary material to Costa,
  R. J., Gerstung, M. (2022), The R package $\texttt{ebmstate}$ for disease progression analysis
  under empirical Bayes Cox models, *Biometrical Journal*. </font>
---
...
file_paths<-c("./data/coxph_vs_coxrfx_sim_illness_death_250obs_1group_per_trans_10vars_each_trans_500sets_dfMethod_unifParams_allHyperParams.Rdata","./data/coxph_vs_coxrfx_sim_illness_death_1000obs_1group_per_trans_10vars_each_trans_500sets_dfMethod_unifParams_allHyperParams.Rdata","./data/coxph_vs_coxrfx_sim_illness_death_2000obs_1group_per_trans_10vars_each_trans_500sets_dfMethod_unifParams_allHyperParams.Rdata","./data/coxph_vs_coxrfx_sim_illness_death_4000obs_1group_per_trans_10vars_each_trans_500sets_dfMethod_unifParams_allHyperParams.Rdata")
...
file1<-"./data/coxph_vs_coxrfx_sim_illness_death_4000obs_1group_per_trans_10vars_each_trans_500sets_dfMethod_unifParams_allHyperParams.Rdata"
...
#Calculate state occupation probabilities
probtrans_object<-probtrans_fft("health",msfit_object,seq(0,80,length.out=40000))
rel_freq_1<-sapply(time_vector,rel_freq,state=1)
rel_freq_12<-rel_freq_1+sapply(time_vector,rel_freq,state=2)
rel_freq_123<-rel_freq_12+sapply(time_vector,rel_freq,state=3)
rel_freq_1234<-rel_freq_123+sapply(time_vector,rel_freq,state=4)
...
file1<-"./data/dense_sim_1000obs_1group_for_all_trans_500vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
...
rdata_names[[1]]<-c(
  "./data/Linear_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_10vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
  ,  "./data/Linear_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_100vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
  ,"./data/Linear_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_200vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
  ,"./data/Linear_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_300vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
  ,"./data/Linear_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_400vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
  ,"./data/Linear_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_500vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
)
rdata_names[[2]]<-c(
  "./data/Comp_risks_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_10vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
  ,"./data/Comp_risks_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_100vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
  ,"./data/Comp_risks_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_200vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
  ,"./data/Comp_risks_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_300vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
  ,"./data/Comp_risks_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_400vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
  ,"./data/Comp_risks_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_500vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
)
rdata_names[[3]]<-c(
  "./data/M_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_10vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
  ,"./data/M_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_100vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
  ,"./data/M_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_200vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
  ,"./data/M_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_300vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
  ,"./data/M_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_400vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
  ,"./data/M_structure_1000patients/dense_sim_1000obs_1group_for_all_trans_500vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
)

### Batch 2: each simulated data set has 100 patients
rdata_names<-vector("list",3)
rdata_names[[1]]<-c(
  "./data/Linear_structure_100patients/dense_sim_100obs_1group_for_all_trans_10vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
  ,"./data/Linear_structure_100patients/dense_sim_100obs_1group_for_all_trans_40vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
  ,"./data/Linear_structure_100patients/dense_sim_100obs_1group_for_all_trans_70vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
  ,  "./data/Linear_structure_100patients/dense_sim_100obs_1group_for_all_trans_100vars_each_group_100sets_dfMethod_unifParams_allHyperParams_LinearStructure.Rdata"
)
rdata_names[[2]]<-c(
  "./data/Comp_risks_structure_100patients/dense_sim_100obs_1group_for_all_trans_10vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
  ,"./data/Comp_risks_structure_100patients/dense_sim_100obs_1group_for_all_trans_40vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
  ,"./data/Comp_risks_structure_100patients/dense_sim_100obs_1group_for_all_trans_70vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
  ,"./data/Comp_risks_structure_100patients/dense_sim_100obs_1group_for_all_trans_100vars_each_group_100sets_dfMethod_unifParams_allHyperParams_CompetingRisksTransStructure.Rdata"
)
rdata_names[[3]]<-c(
  "./data/M_structure_100patients/dense_sim_100obs_1group_for_all_trans_10vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
  ,"./data/M_structure_100patients/dense_sim_100obs_1group_for_all_trans_40vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
  ,"./data/M_structure_100patients/dense_sim_100obs_1group_for_all_trans_70vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
  ,"./data/M_structure_100patients/dense_sim_100obs_1group_for_all_trans_100vars_each_group_100sets_dfMethod_unifParams_allHyperParams_MtransStructure.Rdata"
)
